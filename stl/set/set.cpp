...
void set_ex4() {
	...
	todos.insert(Todo4(1, "농구 하기"));
	todos.insert(Todo4(2, "수학 숙제 하기"));
	todos.insert(Todo4(1, "프로그래밍 프로젝트"));
	todos.insert(Todo4(3, "친구 만나기"));
	todos.insert(Todo4(2, "영화 보기"));

	print_set(todos);

	std::cout << "-------------" << std::endl;
	std::cout << "숙제를 끝냈다면!" << std::endl;
	todos.erase(todos.find(Todo4(2, "수학 숙제 하기")));
	print_set(todos);
}
